...
export default function AuthPage() {
  ...
  return (
    <main className="min-h-screen bg-klinik-bg text-klinik-text flex flex-col items-center justify-center p-6 md:p-12 relative overflow-hidden">
        
        {/* Back to Home Button */}
        <Link href="/" className="absolute top-8 left-8 flex items-center gap-2 text-klinik-muted hover:text-klinik-text transition-colors text-sm font-medium">
        ...
        <div className="w-full max-w-md relative z-10">
           ...
           {/* Action Area */}
           <div className="w-full bg-klinik-surface p-8 md:p-10 shadow-sm border border-klinik-line rounded-lg">
              
              {/* Brand icon mini */}
              <div className="w-10 h-10 bg-klinik-primary text-klinik-surface flex items-center justify-center text-lg font-bold rounded-lg rounded-tr-sm mb-8 shadow-[0_4px_14px_rgba(13,148,136,0.3)] mx-auto">
                K
              </div>

              <div className="flex gap-6 mb-10 border-b border-klinik-line justify-center">
                 <button 
                   type="button" 
              ...
              <p className="text-klinik-muted mb-8 text-sm leading-relaxed text-center">
                 {mode === "login" ? "Insira suas credenciais para gerenciar a clínica." : "Forneça os detalhes para estruturar o seu Agente."}
              </p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                 ...
                 <button 
                   ...
                   className="mt-2 h-12 bg-klinik-text hover:bg-black text-white font-medium transition-all disabled:opacity-70 disabled:cursor-not-allowed rounded-sm"
                 >
                   {isSubmitting ? "Processando..." : (mode === "login" ? "Acessar painel" : "Criar espaço de trabalho")}
                 </button>
              </form>
           </div>
        </div>
