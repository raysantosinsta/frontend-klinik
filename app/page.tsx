...
export default function EditorialLandingPage() {
  return (
    <main className="min-h-screen bg-[#F9F9F8] text-[#1A1A1A] selection:bg-klinik-primary/20 font-sans">
      ...
      <nav className="absolute top-0 w-full z-50 p-6 md:p-10 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-sm font-semibold uppercase tracking-widest">Klinik OS</span>
        </div>
        <div className="flex items-center gap-6">
          <Link href="/auth" className="text-xs uppercase tracking-widest font-semibold hover:opacity-70 transition-opacity">
            Acessar
          </Link>
      ...
      <section className="relative w-full h-[90vh] md:h-screen flex items-end p-6 md:p-16">
        <Image 
        ...
        <div className="relative z-20 max-w-4xl bg-white/90 backdrop-blur-md p-8 md:p-12 shadow-2xl">
          <h1 className="text-4xl md:text-6xl font-light tracking-tight leading-[1.1] mb-6">
            A arte do cuidado <br/> livre de telas.
          </h1>
          <p className="text-lg md:text-xl text-gray-600 font-light max-w-xl mb-8">
      ...
      <section className="py-24 md:py-40 px-6 max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
        ...
        <div className="w-full md:w-1/2">
          <h2 className="text-3xl md:text-5xl font-light tracking-tight mb-8">Presença absoluta.</h2>
      ...
      <section className="bg-[#1A1A1A] text-white py-24 md:py-40 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse items-center gap-16">
          ...
          <div className="w-full md:w-1/2 md:pr-12">
            <h2 className="text-3xl md:text-5xl font-light tracking-tight mb-8">Intervenção Zero.</h2>
      ...
      <section className="py-24 md:py-40 px-6 max-w-7xl mx-auto">
        <div className="text-center mb-24">
          <h2 className="text-3xl md:text-5xl font-light tracking-tight mb-6">Investimento.</h2>
          <p className="text-gray-500 font-light text-lg">Projetado para diferentes escalas operacionais.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-0 border-y border-[#1A1A1A]">
          
          {/* Starter */}
          <div className="p-10 border-b md:border-b-0 md:border-r border-[#1A1A1A]">
          ...
          {/* Pro */}
          <div className="p-10 bg-white shadow-2xl scale-105 z-10 relative">
          ...
          {/* Avançado */}
          <div className="p-10 md:border-l border-[#1A1A1A]">
      ...
      {/* Footer / Imagem Final */}
      <section className="relative w-full h-[50vh] flex items-center justify-center p-6 text-white text-center">
        <Image 
